...
#import "OPSoundRecorderConstants.h"
...
@property(nonatomic, strong) OPMeterTable *meterTable;
...
{
    __strong OPSoundRecorder *THIS = (__bridge OPSoundRecorder*) inRefCon;
...
@implementation OPSoundRecorder
{
...
{
    if (self = [super init]) {
        self.meterTable = [[OPMeterTable alloc] init];
